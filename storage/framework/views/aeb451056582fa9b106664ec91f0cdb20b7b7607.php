...
<?php $__env->startPush('scripts'); ?>
    <script>
        <?php if($name === 'related_products'): ?>
            DataTable.setSelectedIds('#related_products .table', <?php echo old_json('related_products', $product->relatedProductList(), JSON_NUMERIC_CHECK); ?>);
        <?php elseif($name === 'up_sells'): ?>
            DataTable.setSelectedIds('#up_sells .table', <?php echo old_json('up_sells', $product->upSellProductList(), JSON_NUMERIC_CHECK); ?>);
        <?php elseif($name === 'cross_sells'): ?>
            DataTable.setSelectedIds('#cross_sells .table', <?php echo old_json('cross_sells', $product->crossSellProductList(), JSON_NUMERIC_CHECK); ?>);
        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nnhshu/workspace/sithimy/Modules/Product/Resources/views/admin/products/tabs/products.blade.php ENDPATH**/ ?>