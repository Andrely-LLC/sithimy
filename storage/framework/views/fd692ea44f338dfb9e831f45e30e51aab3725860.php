...
<?php $__env->startSection('title', trans('storefront::brands.brands')); ?>
            ...
            <div class="all-brands">
                    ...
                    <div class="all-brands-inner">
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-3 col-md-6 col-9">
                                <a href="<?php echo e($brand->url()); ?>" class="brand-image">
                                    <?php if($brand->logo->exists): ?>
                                        <img src="<?php echo e($brand->logo->path); ?>" alt="brand image">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('themes/storefront/public/images/image-placeholder.png')); ?>" class="image-placeholder" alt="brand image">
                                    <?php endif; ?>
                                </a>
                            </div>
                ...
                <?php else: ?>
                    <div class="empty-message">
                        ...
                        <h2><?php echo e(trans('storefront::brands.no_brand_found')); ?></h2>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('public.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_7.4.2\htdocs\sithimy\Themes\Storefront\views/public/brands/index.blade.php ENDPATH**/ ?>