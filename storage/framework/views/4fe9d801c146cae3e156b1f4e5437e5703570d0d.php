    ...
    <div class="slide">
        <div class="slide-header clearfix">
            <span class="pull-left">
                <?php echo e(trans('product::products.form.downloadable_files')); ?>
        ...
        <div class="slide-body">
            <div class="table-responsive">
                <table class="options table table-bordered">
                    <thead class="hidden-xs">
                        <tr>
                            <th></th>
                            <th><?php echo e(trans('product::products.form.file')); ?></th>
                            <th></th>
                        </tr>
                    </thead>
            ...
            <button type="button" class="btn btn-default" id="add-new-file">
                <?php echo e(trans('product::products.form.add_new_file')); ?>
...
<?php echo $__env->make('product::admin.products.tabs.templates.download', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->startPush('globals'); ?>
    <script>
        FleetCart.data['product.downloads'] = <?php echo old_json('downloads', $product->downloads ?? []); ?>;
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nnhshu/workspace/sithimy/Modules/Product/Resources/views/admin/products/tabs/downloads.blade.php ENDPATH**/ ?>