<script type="text/html" id="flash-sale-product-template">
    <div class="panel">
        <div class="panel-header clearfix">
            ...
            <?php echo e(trans('flashsale::flash_sales.form.flash_sale_product')); ?>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-product-id">
                            <?php echo e(trans('flashsale::attributes.product')); ?><span class="m-l-5 text-red">*</span>
                        </label>
                        ...
                        <select name="products[<%- productPanelNumber %>][product_id]"
                            ...
                            data-url="<?php echo e(route('admin.products.index')); ?>"
                        >
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-campaign-end">
                            <?php echo e(trans('flashsale::attributes.end_date')); ?><span class="m-l-5 text-red">*</span>
                        </label>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-price">
                            <?php echo e(trans('flashsale::attributes.price')); ?><span class="m-l-5 text-red">*</span>
                        </label>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-qty">
                            <?php echo e(trans('flashsale::attributes.quantity')); ?><span class="m-l-5 text-red">*</span>
                        </label>
...
<?php /**PATH C:\xampp_7.4.2\htdocs\sithimy\Modules/FlashSale/Resources/views/admin/flash_sales/templates/product.blade.php ENDPATH**/ ?>