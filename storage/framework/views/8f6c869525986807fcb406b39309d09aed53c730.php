        ...
        <div class="col-md-18">
            ...
            <div class="ship-to-different-address-form" v-show="form.ship_to_a_different_address" v-cloak>
                ...
                <div class="select-address" v-if="hasAddress">
                    <div class="form-group">
                        ...
                        <span class="error-message" v-if="! form.newShippingAddress && errors.has('shipping.address_1')">
                            <?php echo e(trans('storefront::checkout.you_must_select_an_address')); ?>
                ...
                <div class="add-new-address-wrap">
                    ...
                    >
                        <?php echo e(trans('storefront::checkout.add_new_address')); ?>
...
<?php /**PATH /Users/nnhshu/workspace/sithimy/Themes/Storefront/views/public/checkout/create/form/shipping_details.blade.php ENDPATH**/ ?>